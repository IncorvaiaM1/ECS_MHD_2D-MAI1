...
os.makedirs( "temp_data3/newton", exist_ok=True)
...
input_dict, param_dict = dictionaryIO.load_dicts("temp_data3/converted_Re40_solutions_weak_B/Re40_solution_1.npz")
...
for i in range(maxit):
    ...
    dictionaryIO.save_dicts( f"temp_data3/newton/{i}", input_dict, param_dict )
